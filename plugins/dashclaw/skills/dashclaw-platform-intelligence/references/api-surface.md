...
**310 active routes** (verified 2026-06-11 against `docs/api-inventory.json`): 54 stable, 24 beta, 232 experimental. Node SDK uses camelCase, Python SDK uses snake_case.
