...
**298 active routes** (verified 2026-06-06 against `docs/api-inventory.json`): 50 stable, 24 beta, 224 experimental. Node SDK uses camelCase, Python SDK uses snake_case.
