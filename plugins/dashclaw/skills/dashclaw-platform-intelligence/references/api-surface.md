...
**303 active routes** (verified 2026-06-10 against `docs/api-inventory.json`): 51 stable, 24 beta, 228 experimental. Node SDK uses camelCase, Python SDK uses snake_case.
