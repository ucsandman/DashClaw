...
**219 active routes** (verified 2026-07-06 against `docs/api-inventory.json`): 53 stable, 22 beta, 165 experimental. Node SDK uses camelCase, Python SDK uses snake_case.
