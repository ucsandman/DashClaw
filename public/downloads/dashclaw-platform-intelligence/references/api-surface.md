...
**337 active routes** (verified 2026-07-06 against `docs/api-inventory.json`): 57 stable, 24 beta, 256 experimental. Node SDK uses camelCase, Python SDK uses snake_case.
