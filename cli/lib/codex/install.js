...
export function buildAgentsMdBlock({ baseUrl } = {}) {
  const lines = [
    ...
    '',
    "Call `dashclaw_guard` with the action you intend to take. Pass",
    '`confidence` (0-100, your honest odds the action completes without a',
    'human) on every dashclaw_guard call; it is scored later. You will get',
