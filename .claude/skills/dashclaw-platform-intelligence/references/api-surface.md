...
**146 active routes** (verified 2026-07-07 against `docs/api-inventory.json`): 52 stable, 20 beta, 128 experimental. Node SDK uses camelCase, Python SDK uses snake_case.
