...
**215 active routes** (verified 2026-07-07 against `docs/api-inventory.json`): 52 stable, 22 beta, 162 experimental. Node SDK uses camelCase, Python SDK uses snake_case.
