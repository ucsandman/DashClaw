...
**116 active routes** (verified 2026-07-07 against `docs/api-inventory.json`): 38 stable, 17 beta, 61 experimental. Node SDK uses camelCase, Python SDK uses snake_case.
