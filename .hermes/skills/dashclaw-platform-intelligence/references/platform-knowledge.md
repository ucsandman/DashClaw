...
- SDKs:
  - **Node v2 — governance runtime** (`sdk/dashclaw.js`, 56 methods across Core Governance, Execution Studio, Messaging, Sessions, Drift Detection, and Capability Runtime). This is the SDK that ships as the `dashclaw` package.
  ...
  - **Python — full platform** (`sdk-python/dashclaw/client.py`, 114 methods).
