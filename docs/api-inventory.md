...
| `/api/plans/{planId}/attest` | `POST` | `experimental` | `(default)` | `app/api/plans/[planId]/attest/route.ts` |
...
| `/api/signals` | `DELETE, GET, POST` | `experimental` | `(default)` | `app/api/signals/route.ts` |
