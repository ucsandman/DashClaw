...
| HTTP API — all routes with maturity tier | [API inventory](./api-inventory.md) (generated; **245 routes**: 53 stable, 22 beta, 170 experimental) |
...
| MCP server (`@dashclaw/mcp-server`) | [`mcp-server/README.md`](../mcp-server/README.md) — all **29 governance MCP tools**, 6 resources, config |
