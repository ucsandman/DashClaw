...
| HTTP API — all routes with maturity tier | [API inventory](./api-inventory.md) (generated; **272 routes**: 53 stable, 23 beta, 196 experimental) |
...
| MCP server (`@dashclaw/mcp-server`) | [`mcp-server/README.md`](../mcp-server/README.md) — all **31 governance MCP tools**, 6 resources, config |
