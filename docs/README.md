...
| HTTP API — all routes with maturity tier | [API inventory](./api-inventory.md) (generated; **179 routes**: 52 stable, 18 beta, 109 experimental) |
...
| MCP server (`@dashclaw/mcp-server`) | [`mcp-server/README.md`](../mcp-server/README.md) — all **23 governance MCP tools**, 6 resources, config |
