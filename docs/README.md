...
| HTTP API — all routes with maturity tier | [API inventory](./api-inventory.md) (generated; **219 routes**: 53 stable, 20 beta, 146 experimental) |
...
| MCP server (`@dashclaw/mcp-server`) | [`mcp-server/README.md`](../mcp-server/README.md) — all **26 governance MCP tools**, 6 resources, config |
