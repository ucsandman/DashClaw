...
| HTTP API — all routes with maturity tier | [API inventory](./api-inventory.md) (generated; **334 routes**: 57 stable, 24 beta, 253 experimental) |
...
| MCP server (`@dashclaw/mcp-server`) | [`mcp-server/README.md`](../mcp-server/README.md) — all **33 governance MCP tools**, 6 resources, config |
