# Owner roadmap v8 — the vigil (CLOSED 2026-07-06)

> **Closed by [`THESIS.md`](../../../THESIS.md) (the v5.0.0 cull).** This era's
> steering role is superseded: the thesis *is* the product-definition branch
> decision, so v8.5's "branch selected by the read" mechanism is retired and
> v8.4's health floor folds into ordinary maintenance. The two time-gated
> measurement reads — v8.1 cohort (≥2026-07-19) and v8.6 exit (≥2026-07-20) —
> still run as scheduled; they are carried forward as the only open
> obligations in the current [`../owner-roadmap.md`](../owner-roadmap.md).
> Everything below is history, retained under the "eras are archived, not
> erased" rule.
...
[`archive/owner-roadmap-v1-v3.md`](owner-roadmap-v1-v3.md); v4
(v4.1–v4.6, "no ungoverned lane", v4.49.1–v4.54.0) at
[`archive/owner-roadmap-v4.md`](owner-roadmap-v4.md); v5
(v5.1–v5.5, "the first mile", v4.55.0–v4.59.0) at
[`archive/owner-roadmap-v5.md`](owner-roadmap-v5.md); v6
(v6.1–v6.5, "the reach era", v4.59.1–v4.60.1) at
[`archive/owner-roadmap-v6.md`](owner-roadmap-v6.md); v7
(v7.1–v7.5, "the second mile", v4.65.0–v4.66.0) at
[`archive/owner-roadmap-v7.md`](owner-roadmap-v7.md).
