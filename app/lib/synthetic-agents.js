...
export const SYNTHETIC_AGENT_RE = /^(smoke-|ci-smoke$|sdk-live-test-agent|demo-e2e-verifier$|test$|test-|loadtest-|bench-agent-|analytics-agent$|openai-deployer-1$|rogue-agent$)/;
