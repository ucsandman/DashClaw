...
export const PACK_PREVIEWS: Record<string, PackPreview> = {
  ...
  'claude-code-starter': {
    ...
    description: 'Day-one baseline for coding agents — holds mass-destructive ops for approval, gates network calls and package installs, rate-limits runaways. Install first; stack layered-intelligence on top.',
  ...
  'catastrophe-only': {
    ...
    description: 'The self-hosted default — holds mass-destructive operations, secret-file writes, force-pushes over protected branches, and real-money spend for approval, rate-limits runaways. Nothing is refused outright. Everything else runs.',
