...
export const platformFeatures = [
  ...
  { icon: Network, title: 'MCP Server', description: 'Connect any MCP client to DashClaw governance with one config line. 29 tools and 6 resources over stdio or Streamable HTTP. Works with Claude Code, Claude Desktop, and Managed Agents.' },
