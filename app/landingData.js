...
export const platformFeatures = [
  ...
  { icon: Network, title: 'MCP Server', description: 'Connect any MCP client to DashClaw governance with one config line. 33 governance tools and 6 resources over stdio or Streamable HTTP, plus credential-gated provider execution and verified launch plans on the local server. Works with Claude Code, Claude Desktop, and Managed Agents.' },
...
// 33 governance tools + 6 resources
