...
hermes dashclaw doctor`}
        ...
        <section>
          <SectionHeader
            ...
            title="MCP server"
            description="23 governance tools plus 6 read-only resources. Ships inside every plugin above as the on-disk path mcp-server/bin/dashclaw-mcp.js. Also reachable as Streamable HTTP at /api/mcp on any DashClaw deployment, no install required."
          />
