...
hermes dashclaw doctor`}
        ...
        <section>
          <SectionHeader
            ...
            title="MCP server"
            description="15 governance tools plus 6 read-only resources. Ships inside every plugin above as the on-disk path mcp-server/bin/dashclaw-mcp.js. Also reachable as Streamable HTTP at /api/mcp on any DashClaw deployment, no install required."
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="rounded-xl border border-border bg-surface-secondary p-5">
              ...
              <p className="text-xs text-text-secondary leading-relaxed mb-3">
                Canonical 71-method surface across core governance, durable finality, learning, messaging, handoffs, scanning, threads, sessions, execution-studio domains, x402 spend governance, work orders, and drift detection.
              </p>
            ...
            <div className="rounded-xl border border-border bg-surface-secondary p-5">
              ...
              <p className="text-xs text-text-secondary leading-relaxed mb-3">
                Broader Python surface (129 methods) with framework integrations: LangChain callback handler, CrewAI task instrumentation, AutoGen conversation monitoring, and x402 spend governance.
              </p>
