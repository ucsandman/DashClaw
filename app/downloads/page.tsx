          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="rounded-xl border border-border bg-surface-secondary p-5">
              ...
              <p className="text-xs text-text-secondary leading-relaxed mb-3">
                Canonical 112-method surface across core governance, durable finality, scoring, learning, messaging, handoffs, scanning, threads, sessions, execution-studio domains, x402 spend governance, work orders, and drift detection.
              </p>
            ...
            <div className="rounded-xl border border-border bg-surface-secondary p-5">
              ...
              <p className="text-xs text-text-secondary leading-relaxed mb-3">
                Broader Python surface (196 methods) with framework integrations: LangChain callback handler, CrewAI task instrumentation, AutoGen conversation monitoring, and x402 spend governance.
              </p>
