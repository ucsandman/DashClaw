...
export default function WidgetPage() {
  ...
  return (
    <main className="flex min-h-screen w-full justify-center bg-surface-primary text-primary sm:items-center sm:p-4">
      <div className="flex h-screen w-full max-w-[380px] flex-col overflow-hidden border border-border bg-surface-secondary sm:h-auto sm:max-h-[88vh] sm:rounded-2xl sm:shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_24px_70px_rgba(0,0,0,0.55)]">
        ...
        {toast ? (
          <div
            role="alert"
            className="border-t border-error/30 bg-error-subtle px-3 py-2 text-center text-[11px] text-error"
          >
            {toast}
          </div>
        ) : null}
