...
This gives the agent 12 governance tools and 4 resources automatically. The core-governance tools are listed below; for the full inventory, see [`mcp-server/README.md`](../../mcp-server/README.md).
...
| Governance tools | 12 tools + 4 resources | 3 tools |
