...
The Python SDK is the full platform SDK (114 methods). The constructor accepts both v2-compatible and v1-extended parameters.
...
This SDK provides the full DashClaw platform surface (114 methods), which is parity with the (now DEPRECATED, removed in v5.0.0) [Node.js v1 legacy SDK](https://github.com/ucsandman/DashClaw/tree/main/sdk/legacy).

The Node.js v2 SDK exposes a curated subset of **56 methods** focused on agent governance. The following Python methods are available in both the Node.js v2 SDK and this Python SDK:
