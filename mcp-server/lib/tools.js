...
export const TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        description: 'Create a Team Task — one record per multi-agent /team run. Groups the inter-agent ' +
    ...
    },
    {
        ...
        description: 'Append one event to a Team Task timeline (delegation, reply, status, approval_needed, ' +
    ...
    },
    {
        ...
        description: 'Update a Team Task: status transitions (open → in_progress → awaiting_approval → ' +
...
export function createToolHandlers(client) {
    ...
    return {
        ...
        async dashclaw_task_create(input) {
        ...
        async dashclaw_task_event(input) {
        ...
        async dashclaw_task_update(input) {
