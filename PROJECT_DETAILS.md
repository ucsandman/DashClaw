...
As of this verification (2026-07-07), generated API inventory reports **157 routes**: **42 stable**, **18 beta**, **97 experimental**.
...
The canonical Node SDK currently exposes **56 public methods** in `sdk/dashclaw.js` and the Python SDK **114** in `sdk-python/dashclaw/client.py` (both reproducible via `npm run sdk:count` — excludes the constructor and `_`-private methods). The Node surface includes:
