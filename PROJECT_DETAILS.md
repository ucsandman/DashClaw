...
As of this verification (2026-07-06), generated API inventory reports **245 routes**: **53 stable**, **22 beta**, **170 experimental**.
...
The canonical Node SDK currently exposes **121 public methods** in `sdk/dashclaw.js` and the Python SDK **204** in `sdk-python/dashclaw/client.py` (both reproducible via `npm run sdk:count` — excludes the constructor and `_`-private methods). The Node surface includes:
