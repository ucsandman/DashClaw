...
As of this verification (2026-07-07), generated API inventory reports **215 routes**: **52 stable**, **20 beta**, **143 experimental**.
...
The canonical Node SDK currently exposes **101 public methods** in `sdk/dashclaw.js` and the Python SDK **177** in `sdk-python/dashclaw/client.py` (both reproducible via `npm run sdk:count` — excludes the constructor and `_`-private methods). The Node surface includes:
