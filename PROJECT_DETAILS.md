...
As of this verification (2026-06-12), generated API inventory reports **321 routes**: **54 stable**, **24 beta**, **243 experimental**.
...
The canonical Node SDK currently exposes **137 public methods** in `sdk/dashclaw.js` and the Python SDK **233** in `sdk-python/dashclaw/client.py` (both reproducible via `npm run sdk:count` — excludes the constructor and `_`-private methods). The Node surface includes:
