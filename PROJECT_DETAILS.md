...
As of this verification (2026-07-05), generated API inventory reports **332 routes**: **57 stable**, **24 beta**, **251 experimental**.
...
The canonical Node SDK currently exposes **149 public methods** in `sdk/dashclaw.js` and the Python SDK **234** in `sdk-python/dashclaw/client.py` (both reproducible via `npm run sdk:count` — excludes the constructor and `_`-private methods). The Node surface includes:
