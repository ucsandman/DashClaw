...
As of this verification (2026-07-06), generated API inventory reports **219 routes**: **53 stable**, **20 beta**, **146 experimental**.
...
The canonical Node SDK currently exposes **107 public methods** in `sdk/dashclaw.js` and the Python SDK **183** in `sdk-python/dashclaw/client.py` (both reproducible via `npm run sdk:count` — excludes the constructor and `_`-private methods). The Node surface includes:
