...
This project is indexed by GitNexus as **DashClaw** (25469 symbols, 51179 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
Last indexed: 2026-07-02 (commit f970f480). Confidence: 100%.
### Architecture
...
| `package-lock.json` | 99.9th percentile | 59 | Wes Sander |
| `app/lib/guard.ts` | 99.9th percentile | 19 | Wes Sander |
