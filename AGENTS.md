...
This project is indexed by GitNexus as **DashClaw** (25487 symbols, 51199 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
Last indexed: 2026-07-02 (commit 7519439b). Confidence: 100%.
### Architecture
...
| `app/lib/guard.ts` | 99.9th percentile | 20 | Wes Sander |
| `package-lock.json` | 99.9th percentile | 60 | Wes Sander |
| `public/livingcode/index.html` | 99.8th percentile | 71 | Wes Sander |
